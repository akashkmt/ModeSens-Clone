            ...
            <Wrapper>
                <WrapperInner>
                    ...
                    <ProductDiscription>
                        ...
                        <PriceDiv>
                            <OffPriceP> Rs : {productData.offprice}</OffPriceP> <PriceP>Rs :  {productData.price} ({Math.floor(( 100 / productData.offprice)  * (productData.offprice - productData.price))} %) Off</PriceP>
                        </PriceDiv>
